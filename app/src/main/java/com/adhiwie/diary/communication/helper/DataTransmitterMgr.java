...
import com.adhiwie.diary.communication.FileTransmitter;
import com.adhiwie.diary.debug.CustomExceptionHandler;
import com.adhiwie.diary.exception.FileNotCreatedException;
import com.adhiwie.diary.file.DataInterface;
import com.adhiwie.diary.file.FileMgr;
import com.adhiwie.diary.file.FileOperations;
import com.adhiwie.diary.file.FilePaths;
import com.adhiwie.diary.sensor.pull.CallSensor;
import com.adhiwie.diary.sensor.pull.PhoneUsageSensor;
import com.adhiwie.diary.sensor.pull.SmsSensor;
...
public class DataTransmitterMgr {
    ...
    private void transmitQuestionnaireData() {
        transmitData(new DataTypes().DAILY_STUDY_QUESTIONNAIRE);
