...
import com.adhiwie.diary.communication.helper.PlanDataTransmission;
...
public class PlanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        routine = "am about going to bed at the night";
    ...
    private void goToStepOne() {
        ...
        spannable.setSpan(
                ...
                plan.indexOf("complete self-report diary"),
                plan.indexOf("complete self-report diary") + String.valueOf("complete self-report diary").length(),
                Spannable.SPAN_EXCLUSIVE_EXCLUSIVE
        );
    ...
    private void goToStepTwo() {
        ...
        final String plan = "then I will complete self-report diary";
    ...
    private void goToStepThree(String condition) {
        ...
        if(condition.equalsIgnoreCase("am about going to bed")) {
